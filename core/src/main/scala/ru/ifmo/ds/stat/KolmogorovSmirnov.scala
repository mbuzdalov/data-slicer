...
/**
  * The Kolmogorov-Smirnov test to be used while detecting differences or partial statistical domination.
  */
object KolmogorovSmirnov {
  ...
  private abstract class KSCommon extends StatisticalTest[Rational] {
    ...
    private def oneMinusP(statistic: Rational, firstSampleSize: Int, secondSampleSize: Int): Double = {
      ...
      pIdenticalDistributionIsInBounds(minDiff, maxDiff, firstSampleSize, secondSampleSize)
    }
  }
  ...
  /**
    ...
    */
  private def collectStatisticsWithProbabilities(firstSampleSize: Int,
                                                 secondSampleSize: Int,
                                                 statExtractor: Rational => Rational,
                                                 pSmirnov: (Rational, Int, Int) => Double
                                                ): Iterable[(Rational, Double)] = {
